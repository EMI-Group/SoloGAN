...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--time_dir', type=str, help='the experiment time dir')
        ...
        self.parser.add_argument('--how_many', type=int, default=250, help='how many test images to run')
